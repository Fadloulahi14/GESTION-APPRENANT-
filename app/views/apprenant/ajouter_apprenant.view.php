...
<div class="containerajour_apprenant">
  ...
  <form action="index.php?page=traiter_ajout_apprenant" method="POST" enctype="multipart/form-data" class="form-ajout">
        ...
        <div class="form-group">
          ...
          <div class="file-upload">
            <div class="upload-box">
              <input type="file" id="document" name="document" accept="image/*" onchange="previewImage(this)">
              <p>Cliquez ou glissez une image ici</p>
            </div>
            <div class="preview-zone" id="imagePreview" style="display: none;">
